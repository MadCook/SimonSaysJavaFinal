...
public class GameOverMsg {
	...
	public GameOverMsg(ScoreBoard theScore){
		 ...
		 okIcon = new ImageIcon("Resources/ok.png");
		 
		 UIManager.put("OptionPane.background", Color.WHITE.darker());
		 UIManager.put("Panel.background", Color.WHITE.darker());
	...
	/** If the score the player received tied or beat the high Score it returns a
